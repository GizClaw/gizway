...
for bundle in account gizpay-admin gizpay-webhooks gizway-admin gizway-user gizway-public internal-gizpay; do
...
mkdir -p "${generated_dir}/account" "${generated_dir}/gizpayadmin" "${generated_dir}/gizpaywebhooks" "${generated_dir}/gizwayadmin" "${generated_dir}/gizwayuser" "${generated_dir}/gizwaypublic" "${generated_dir}/internalgizpay"
...
"${GO:-go}" run "${generator}" -generate types,client,std-http,spec -package gizpayadmin -o "${generated_dir}/gizpayadmin/api.gen.go" "${bundle_dir}/gizpay-admin.json"
