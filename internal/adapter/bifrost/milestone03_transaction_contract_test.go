...
func TestMilestone03AdapterExposesCallerOwnedConfigTransaction(t *testing.T) {
	...
	for _, name := range []string{"ExecuteConfigTransaction", "CreateProviderInTransaction", "UpdateProviderInTransaction", "CreateKeyInTransaction", "UpdateKeyInTransaction"} {
