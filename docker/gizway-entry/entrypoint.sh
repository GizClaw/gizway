...
case "$PROFILE" in
  global) required='GLOBAL_HOST GIZPAY_UPSTREAM GIZWAY_UPSTREAM POWERSYNC_PAY_UPSTREAM POWERSYNC_GIZWAY_UPSTREAM' ;;
  cn) required='CN_HOST GIZPAY_UPSTREAM GIZWAY_UPSTREAM POWERSYNC_PAY_UPSTREAM POWERSYNC_GIZWAY_UPSTREAM' ;;
